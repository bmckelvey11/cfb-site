...
- [x] 04-02-PLAN.md — All D-01 launchers + /filter-detail categorical/boolean value tables — MODAL-01, MODAL-04, MODAL-05

**Wave 3** *(blocked on 04-02)*

- [x] 04-03-PLAN.md — Numeric dual-range + BETWEEN + money chart/list + describe coalesce — MODAL-03, MODAL-06
...
- [x] 05-01-PLAN.md — `upcoming` CLI: week resolution (incl. postseason + backward offseason fallback), fetch, normalize, kickoff capture, persist — DASH-03
- [x] 05-02-PLAN.md — `matches_system(require_played=False)` + per-season derivation equivalence — DASH-01, DASH-03
- [x] 05-03-PLAN.md — Route move `/` → `/system`, dashboard shell, My Systems table, sparkline, timeframe tabs, figure cache — DASH-01
...
- [x] 05-06-PLAN.md — Current Matches panel: matching, play text, matched-filter details, all five states — DASH-03
