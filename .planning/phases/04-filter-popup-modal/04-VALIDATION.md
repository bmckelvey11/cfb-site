...
| 04-02-02 | 02 | 2 | MODAL-01, MODAL-04, MODAL-05, MODAL-06 | T-04-07 | Grouped launchers + categorical/boolean table via textContent; fallback controls remain; Save writes ff_*/core lists then filters-form.submit; Cancel leaves form untouched | rendered contract | `python -m pytest tests/test_filter_modal.py -x -k "launcher or fallback or lookahead or table or categorical or boolean or commit or serialize or save"` | ❌ W0 | ⬜ pending |
