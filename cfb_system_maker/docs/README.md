...
| [an-live-lines-2026-09-22.md](an-live-lines-2026-09-22.md) | Why `core.fact_game_line` held impossible closes (82.5 total, −66.5 spread): Action Network in-game prices carry the full-game `period`, and the loader's `MAX` pivot took them. **Fixed** in the loader; 152 totals and 133 spreads across six books move on the next rebuild. Reproduce with `python scripts/audit_an_live_lines.py`. |
