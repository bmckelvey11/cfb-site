...
def _system_to_dict(saved: SavedSystem) -> dict[str, Any]:
    ...
    return {
        ...
        "system": {
            ...
            "exclude_seasons": sorted(system.exclude_seasons),
            "exclude_weeks": sorted(system.exclude_weeks),
            "exclude_teams": sorted(system.exclude_teams),
            "exclude_conferences": sorted(system.exclude_conferences),
            "exclude_providers": sorted(system.exclude_providers),
...
def _system_from_dict(payload: dict[str, Any]) -> SystemFilter:
    ...
    return SystemFilter(
        ...
        # Absent on systems saved before exclusions existed -- default empty.
        exclude_seasons=set(system.get("exclude_seasons", [])),
        exclude_weeks=set(system.get("exclude_weeks", [])),
        exclude_teams=set(system.get("exclude_teams", [])),
        exclude_conferences=set(system.get("exclude_conferences", [])),
        exclude_providers=set(system.get("exclude_providers", [])),
