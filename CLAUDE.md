...
- **Math in Markdown** (`tests/test_docs_math.py` enforces the delimiters). Any `.md` with equations follows three rules. Applies to new docs and to any equation you touch; dated records are not rewritten to comply.
