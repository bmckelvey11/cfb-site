...
**Band ordering for week 3 (added 2026-09-17, withdrawn the same day).** Ordering the slate by band was proposed and then tested (`band_significance.py`, [greenline-band-significance-2026-09-17.md](greenline-band-significance-2026-09-17.md)). Pooled six-band chi-square p = 0.056; 55-59.5 vs rest Fisher p = 0.11; after correcting for six bands inspected, the best band reaching 63% has p = 0.82; the 2023-25 band ranking scored on 2026 flags has AUC 0.47 (no information). Not significant, so the slate is ordered by repriced DK edge inside the window, not by band. Bands stay in the tables as a split to accumulate.
