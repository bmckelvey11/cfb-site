...
Generated by `research/totals/scripts/under_selection_profile.py` on 2026-09-17. 201 full-game unders in the book export, **200 matched** to `core.fact_game` (1 unmatched); record on the matched set **114-86**.
