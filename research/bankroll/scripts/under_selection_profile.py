"""What separates the unders that got bet from the ones that did not, 2023-2025.
    ...
    python research/bankroll/scripts/under_selection_profile.py --out <path.md>
    python research/bankroll/scripts/under_selection_profile.py --self-check
...
def render(d: dict) -> str:
    ...
    out = [
        ...
        "",
        f"Generated by `research/bankroll/scripts/under_selection_profile.py` on "
...
"**4. The bet unders and the Greenline flags do not sit at the same numbers.** "
            ...
            "2023-25 can.",
            "2. **`research/totals/scripts/greenline_unders.py`'s `BANDS` constant does not "
            "reconcile.** Its rows "
