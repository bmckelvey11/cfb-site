...
**Date:** August 27, 2026
**Scope:** Read-only analysis of whether early-week college football games support a viable totals or point-spread model, using live data from `../cfb-site/data`. No production code was changed.
...
> evidence of edge. See [`MODEL.md`](MODEL.md) for the clean 2022–25 re-grade.
...
See [`MODEL.md`](MODEL.md) for features, no-lookahead guarantees, and caveats.
...
- Log takeable open vs close for one season before sizing up (see [`MODEL.md`](MODEL.md#the-test-that-would-actually-settle-it)).
...
2. **Opening line takeability** — Bovada-sourced opens may not have been bettable at size ([`MODEL.md` caveats](MODEL.md#what-would-sink-this)).
